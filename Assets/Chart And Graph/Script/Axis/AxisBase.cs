...
#pragma warning restore 0414
        ...
        [SerializeField]
        [Tooltip("")]
        private bool withEdges;
        public bool WithEdges
        {
            get { return withEdges; }
            set
            {
                withEdges = value;
                RaiseOnChanged();
        ...
        private void DrawCustomDivisions(double scrollOffset, AnyChart parent, Transform parentTransform, ChartDivisionInfo info, IChartMesh mesh, int group, ChartOrientation orientation,  bool oppositeSide, double mainGap)
        {
...
//        }
        ...
        internal void AddCustomDivisionsToChartMesh(double scrollOffset, AnyChart parent, Transform parentTransform, IChartMesh mesh, ChartOrientation orientation)
        {
            double maxValue = ((IInternalUse)parent).InternalMaxValue(this);
            double minValue = ((IInternalUse)parent).InternalMinValue(this);
            double range = maxValue - minValue;
            ...
            if ((MainDivisions.Alignment & ChartDivisionAligment.Opposite) == ChartDivisionAligment.Opposite)
                DrawCustomDivisions(scrollOffset, parent, parentTransform, MainDivisions, mesh, 0, orientation, false, -1);
            if ((MainDivisions.Alignment & ChartDivisionAligment.Standard) == ChartDivisionAligment.Standard)
                DrawCustomDivisions(scrollOffset, parent, parentTransform, MainDivisions, mesh, 0, orientation,  true, -1);
        }
        /// <summary>
