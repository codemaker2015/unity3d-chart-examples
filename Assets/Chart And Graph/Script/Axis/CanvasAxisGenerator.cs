        ...
        private void AddToCanvasChartMesh(CanvasChartMesh mesh)
        {
            ...
            switch(mDivType)
            {
                ...
                case 1:
                    ...
                    break;
                default:
                    mAxis.AddCustomDivisionsToChartMesh(mScrollOffset, mParent, transform, mesh, mOrientation);
                    break;
            }                
        }
        ...
        public void SetAxis(double scrollOffset,AnyChart parent, AxisBase axis, ChartOrientation axisOrientation,int divType)
        {
            ...
            switch (mDivType)
            {
                ...
                case 1:
                    ...
                    break;
                default:
                    mAxis.AddCustomDivisionsToChartMesh(mScrollOffset, mParent, transform, mMesh, mOrientation);
                    break;
            }
